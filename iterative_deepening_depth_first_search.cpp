...
bool iddfs(State start_state, State goal_state, int max_depth, int& depths_explored, int& states_explored){
...
int main() {
    ...
    int depths_explored = 0;
    int states_explored = 0;

    if (!iddfs(start_state, goal_state, max_depth, depths_explored, states_explored)) {
        cout << "Goal state not found within depth limit." << endl;
    }
    cout << "Depths explored: " << depths_explored << endl;
